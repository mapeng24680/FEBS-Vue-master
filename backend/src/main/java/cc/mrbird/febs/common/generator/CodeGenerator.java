...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://118.24.63.244:3306/HosExam?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.cj.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "Hos_Exam";
    // 数据库密码
    private static final String PASSWORD = "12345678";
    // @author 值
    private static final String AUTHOR = "pengpeng";
    // 包的基础路径
